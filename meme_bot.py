...
# ============ LEE VARIABLES DE RENDER ============
# En Render vas a: Settings -> Environment -> Add Environment Variable
...
if not TOKEN or not CANAL:
    ...
    print("   Ve a Render -> Environment y agrega:")
    print("   - TELEGRAM_BOT_TOKEN")
    print("   - TELEGRAM_CHANNEL_ID")
    print("   - LINK_AFILIADO (opcional)")
    exit(1)
...
# 20 memes distribuidos desde 08:00 hasta 22:15
HORAS = [
